...
{
	if (region.T.J === region.aa.J)
	{
		return 'on line ' + region.T.J;
	}
	return 'on lines ' + region.T.J + ' through ' + region.aa.J;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ae: fragment, ag: host, an: path, ap: port_, aw: protocol, ax: query};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {Y: col, aP: contextStack, at: problem, aB: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.aB, s.Y, x, s.c));
	});
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{Y: 1, c: s.c, d: s.d, b: s.b + 1, aB: s.aB + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{Y: s.Y + 1, c: s.c, d: s.d, b: newOffset, aB: s.aB, a: s.a}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{Y: col, c: s0.c, d: s0.d, b: offset, aB: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.aB, s.Y, s);
	};
};
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.b, s.aB, s.Y, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			0,
			{Y: newCol, c: s.c, d: s.d, b: newOffset, aB: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.aB, s.Y, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {Y: s.Y + (newOffset - s.b), c: s.c, d: s.d, b: newOffset, aB: s.aB, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.aB, s.Y - (floatOffset + s.b), invalid, s.c));
		} else {
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {Y: col, at: problem, aB: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.aB, p.Y, p.at);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{Y: 1, c: _List_Nil, d: 1, b: 0, aB: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Main$singleEffect = function (e) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('flex-shrink-0 p-sm-2 w-50')
			]),
		_List_fromArray(
			[
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href(e.i),
								...
								_List_fromArray(
									[
										...
										'data-width',
										$elm$core$String$fromInt(e.n)),
										A2(
										$elm$html$Html$Attributes$attribute,
										'data-height',
										$elm$core$String$fromInt(e.l))
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Exibir Efeito')
									]))
							])),
						A2(
						$elm$html$Html$div,
						...
						_List_fromArray(
							[
								...
								$author$project$Main$textHtml(e.j))
							]))
					]))
			]));
};
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('effects d-flex flex-wrap p-2')
			]),
		A2($elm$core$List$map, $author$project$Main$singleEffect, model));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{aV: $author$project$Main$init, a0: $author$project$Main$subscriptions, a1: $author$project$Main$update, a2: $author$project$Main$view});
